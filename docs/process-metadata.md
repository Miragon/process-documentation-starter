...
for everything about a process that is *not* the flow itself, and it is the dependency graph
...
last_reviewed: 2026-07-06      # when a human last confirmed model = reality
